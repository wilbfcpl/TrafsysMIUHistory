...
set rs = Server.CreateObject("ADODB.recordset")
	...
	sql = "SELECT TOP 1 IOValue from RawHistory WHERE MiuName='Point of Rocks' and SensorName='Counter2' and Status = 0 and Units='count' and PointIndex=2 and PointType=2 ORDER BY RecTime DESC"
	rs.open sql, conn 
